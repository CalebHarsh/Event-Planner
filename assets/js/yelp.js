...
var eventsReturn = {
  "async": true,
  "crossDomain": true,
  "url": "https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/events?longitude=" + search.longitude + "&latitude=" + search.latitude + "&start_date=" + search.start + "&end_date=" + search.end + "&limit=10",
  "method": "GET",
  "headers": {
